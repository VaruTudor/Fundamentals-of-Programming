...
from COPY_UI3_4 import *

def start():
    NumberList=[{'real':5,'imaginary':3},{'real':7,'imaginary':2},{'real':11,'imaginary':4},{'real':13,'imaginary':8},{'real':9,'imaginary':4},{'real':13,'imaginary':2},{'real':12,'imaginary':15},{'real':2,'imaginary':4},{'real':10,'imaginary':3},{'real':9,'imaginary':12}]
    undoList=[]
    ...
    while True:
        ...
        if choice=='1':
            ...
            if command[0]=='add':
                params[0]={'real':params[0][0],'imaginary':params[0][1]} 
                if isinstance(params[0],int):
                    k=params[0]
                    params[0]={'real':k,'imaginary':0} 
                try:
